...
__Course Code__: CSA2001 <br>

---

## About the Project

This project is a simple yet practical ___Personal Finance and Investment Tracker___ built using Python. The main idea behind this project was to create something that can actually be useful in day-to-day life while also applying basic concepts of programming and logic.

Instead of using heavy libraries or complex frameworks, the entire project is built using ___core Python___, which makes it lightweight and easy to run on any system. The program helps in tracking income, expenses, and investments, and also gives insights into spending habits.
